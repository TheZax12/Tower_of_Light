...
class EndScreen:
    ...
    def winning_screen(display_surface: pygame.Surface, main_menu_callback):
        ...
        winning_text_1 = get_font(30).render("Congratulations warrior!", True, text_base_color)
        winning_rect = winning_text_1.get_rect(center=(620, 80))
        winning_text_2 = get_font(30).render("You have defeated the chaos and restored the light to the tower!", True, text_base_color)
        ...
        main_menu_button = Button(MapPosition(500, 300), None, "Main Menu", get_font(40), text_base_color, text_hovering_color)
        quit_button = Button(MapPosition(800, 300), None, "Quit", get_font(40), text_base_color, text_hovering_color)
